...
import CommonCard from '../BOX/CommonCard'
import '../BOX/slider.css';
  ...
  <div className="carousel-inner mt-3 align-items-center    ">
    ...
    <div className="container">
        <div className="row">
            ...
            <div className="col-md-3 col-sm-2 col-xs-2 p-2 ind-card">
                <CommonCard
                 price='Rs 18,000'
                 model='Nokia 6.1 plus'
                 img='https://images.priceoye.pk/samsung-galaxy-s10-lite-pakistan-priceoye-fmbkz.jpg '
                />
            </div>
            <div className="col-md-3 col-sm-2 col-xs-2 p-2 ind-card">
                <CommonCard 
